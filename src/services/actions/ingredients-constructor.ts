...
import { ISetBun, IAddIngredient, IDeleteIngredient, IMoveIngredient, IClearConstructor } from '../actions/interfaces';
...
export const deleteIngredient = (payload: TIngredientType): IDeleteIngredient => ({
