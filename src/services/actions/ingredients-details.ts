...
import { ISetIgredientDetails, IDeleteIgredientDetails } from '../actions/interfaces';

export const setIgredientDetails = (payload: TIngredientType): ISetIgredientDetails => ({
