...
import { ISetIngredientDetails, IDeleteIngredientDetails } from '../actions/interfaces';


export const setIngredientDetails = (payload: TIngredientType): ISetIngredientDetails => ({
